...
<div class="js-stools clearfix jshop_block_filter">
    ...
    <div class="js-stools-container-filters">
        ...
        <div class="js-stools-field-filter" style="display:none;">
...
<thead>
  <tr>
    ...
    <?php }?>
    <th width="170">
        <?php echo JHTML::_( 'grid.sort', 'Code', 'ean', $this->filter_order_Dir, $this->filter_order);?>
    </th>
    ...
    <?php }?>
    <th width="80">
        <?php echo JHTML::_( 'grid.sort', 'Tokens', 'tokens', $this->filter_order_Dir, $this->filter_order);?>
    </th>
    <th width="40">
...
<?php foreach($rows as $row){ ?>
  <tr class="row<?php echo $i % 2;?>">
   ...
   <td>
    ...
    <?php if ($row->image){?>
        <a href="index.php?option=com_jshopping&controller=products&task=edit&product_id=<?php print $row->product_id?>">
            <img src="<?php print getPatchProductImages($row->image, 'small', 1)?>" width="90" border="0" />
        </a>
    <?php }?>
   </td>
   <td>
     <b><a href="index.php?option=com_jshopping&controller=products&task=edit&product_id=<?php echo $row->product_id?>&category_id=<?php echo $category_id?>"><?php echo $row->name;?></a></b>
   ...
   <td class="center">
    <a class="btn btn-micro" href='index.php?option=com_jshopping&controller=products&task=edit&product_id=<?php print $row->product_id?>&category_id=<?php echo $category_id?>'>
        <i class="icon-edit"></i>
    </a>
   </td>
   <td class="center">
    <a class="btn btn-micro" href='index.php?option=com_jshopping&controller=products&task=remove&cid[]=<?php echo $row->product_id?>&category_id=<?php echo $category_id?>' onclick="return confirm('<?php print _JSHOP_DELETE?>')">
