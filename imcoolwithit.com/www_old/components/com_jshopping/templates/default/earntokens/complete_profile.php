...
<div id="complete-profile-info" class="col-sm-8 col-sm-offset-2 col-xs-12" style="display: none;">
</div>
    ...
    <div class="page-content row">
        ...
        <form id="complete-profile-questions" class="earn-tokens-list">
            ...
            <div class="earn-tokens-submit">
				<?php if($this->complete_profile > 0) {?>
        ...
        jQuery.ajax({
            ...
            success: function (data){
                if(data=='success'){
                    ...
                    jQuery('.complete-profile').hide();
                    jQuery('#complete-profile-info').html('<?php include_once('complete_box.php'); ?>').show();
