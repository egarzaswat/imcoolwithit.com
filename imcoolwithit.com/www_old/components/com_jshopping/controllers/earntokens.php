...
class JshoppingControllerEarnTokens extends JControllerLegacy{

    function __construct($config = array()){
        parent::__construct($config);
        JPluginHelper::importPlugin('jshoppingcheckout');
        JDispatcher::getInstance()->trigger('onConstructJshoppingControllerEarnTokens', array(&$this));
    }
...
//        $view->assign('menu', $menu);
    ...
    function displayCompleteProfile(){
		...
		$completed = JSFactory::getUser()->complete_profile;
...
//        $menu = JSFactory::getContentMenu();
        ...
        $view->assign('complete_profile', count($profile_answers_list));
