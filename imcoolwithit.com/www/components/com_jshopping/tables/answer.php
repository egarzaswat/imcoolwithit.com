...
class jshopAnswer extends JTableAvto{

    function __construct( &$_db ){
        parent::__construct('#__answers_earn_tokens', 'id', $_db );
    }

    function getName($id){
        $db = JFactory::getDBO();
        $query = "SELECT answer"." FROM `#__answers_earn_tokens` WHERE id = '".$db->escape($id)."'";
        $db->setQuery($query);
