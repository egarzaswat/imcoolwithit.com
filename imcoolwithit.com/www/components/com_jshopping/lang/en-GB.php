...
define('_JSHOP_EDIT_DATA', 'Settings');
define('_JSHOP_EDIT_SEX', 'I am a: ');
define('_JSHOP_EDIT_LOOKING_FOR', 'Looking For: ');
define('_JSHOP_EDIT_BIRTHDAY', 'Birthday: ');
define('_JSHOP_EDIT_AGE', 'Age: ');
define('_JSHOP_EDIT_DISTANCE', 'Distance: ');
define('_JSHOP_EDIT_FIRST_NAME', 'First name: ');
define('_JSHOP_EDIT_LAST_NAME', 'Last name: ');
define('_JSHOP_EDIT_EMAIL', 'E-mail: ');
define('_JSHOP_EDIT_EPOSTAL_CODE', 'Postal Code: ');
define('_JSHOP_EDIT_BUTTON', 'Save');
...
define('_JSHOP_MR', 'Man');
define('_JSHOP_MS', 'Woman');
define('_JSHOP_STRAIGHT_MAN', 'Straight Man');
define('_JSHOP_GAY_MAN', 'Gay Man');
define('_JSHOP_BI_SEXUAL_MAN', 'Bi Sexual Man');
define('_JSHOP_STRAIGHT_WOMAN', 'Straight Woman');
define('_JSHOP_GAY_WOMAN', 'Gay Woman');
define('_JSHOP_BI_SEXUAL_WOMEN', 'Bi Sexual Woman');
define('_JSHOP_EITHER', 'Everyone');
