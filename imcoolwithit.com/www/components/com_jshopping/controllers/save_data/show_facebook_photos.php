            ...
            <div class="thumbnail">
                ...
                <label style="display: inline-block; position: relative;">
                    <span id="<?php print $photo['id'] . '-cover'; ?>" class="image-style" style="background:url(<?php print $photo['source']; ?>) center center no-repeat;
                        ...
                        <label for="<?php print $photo['id']; ?>" class="upload-to-gallery">Upload to Gallery</label>
                        <input type="button" class="visible-xs-block visible-sm-block set-avatar" name="<?php print $photo['source']; ?>" value="Make Profile Pic"/>
                    </span>
                    <img id="<?php print $photo['id'] . '-checked'; ?>" class="image-checked"
                         src="/templates/protostar/images/system/check.png">
                </label>
            </div>
        </div>
    <?php } ?>
