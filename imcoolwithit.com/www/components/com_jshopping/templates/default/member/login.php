...
<div class = "jshop pagelogin" id="comjshop">
    ...
    <div class = "row-fluid">
        <div class = "span6 login_block">
            ...
            <form method="post" action="<?php print SEFLink('index.php?option=com_jshopping&controller=member&task=loginsave', 1,0, $this->config->use_ssl)?>" name="jlogin" class="form-horizontal">
