...
//        $date_explode = explode(" ", JFactory::getDate()->toSql());
    ...
    public static function getComponentHeader(){
        if(JSFactory::getUser()->register_activate == 1){
            ...
            $html .= '<li><a href="' . JText::_('LINK_USERS_LIST') . '">Search</a></li>';
            ...
            $html .= '<li><a href="' . JText::_('LINK_MESSAGING_RECEIVED') . '">';
            $html .= '<span class="cool-menu-icons cool-messages"><span class="cool-count">'. $count_new_messages . '</span></span>';
            $html .= '<span class="cool-menu-text">' . JText::_('COOL_TOP_MESSAGES') . '</span>';
            $html .= '</a>';
            $html .= '</li>';
            $html .= '<li><a href="' . JText::_('LINK_VISITORS') . '">';
            $html .= '<span class="cool-menu-icons cool-visitors"><span class="cool-count">'. $count_new_visitors . '</span></span>';
            ...
            $html .= '</a>';
            $html .= '</li>';
            $html .= '<li><a class="cool-links" href="' . JText::_('LINK_MY_BOOKMARKS') . '">' . JText::_('COOL_TOP_SAVED_PROFILES') . '</a></li>';
            //$html .= '<li><a class="cool-links" href="/info/community">Community</a></li>';
            $html .= '<li><a class="cool-links" href="/user/logout">Sign out</a></li>';
            $html .= '</ul>';
            $html .= '</div>';

            $html .= '<div class="menu-top-xs">';
            $html .= '<a href="' . JText::_('LINK_EDIT_ACCOUNT') . '" class="menu-settings" title="Your Search Settings"></a>';
            ...
            $html .= '</span>';
            $html .= '<a class="cool-tokens" href="' . JText::_('LINK_EARN_TOKENS') . '" title="Earn more Tokens"><span class="cool-count">'. $count_tokens . '</span><span class="cool-menu-text">' . JText::_('COOL_TOP_TOKENS') . '</span></a>';
            $html .= '</div>';
            $html .= '</div>';
