...
if ($components)
{
	$menu->addChild(new JMenuNode(JText::_('_JSHOP_MENU_MAIN'), '#'), true);

//    $menu->addChild(
//        new JMenuNode(
//            JText::_('_JSHOP_FIELD_HOME'), 'index.php?option=com_jshopping',
//            'class:newarticle')
//    );
//
//    $menu->addSeparator();
    ...
    $menu->addChild(
        new JMenuNode(
            JText::_('_JSHOP_MENU_SPONSORS_CATEGORIES'), '', '')
    );
    $menu->addChild(
        new JMenuNode(
            JText::_('_JSHOP_MENU_COFFEE'), 'index.php?option=com_jshopping&controller=products&category_id=3',
            'class:newarticle')
    );
    $menu->addChild(
        new JMenuNode(
            JText::_('_JSHOP_MENU_RESTAURANTS'), 'index.php?option=com_jshopping&controller=products&category_id=4',
            'class:newarticle')
    );
    $menu->addChild(
        new JMenuNode(
            JText::_('_JSHOP_MENU_MOVIESEVENTS'), 'index.php?option=com_jshopping&controller=products&category_id=5',
            'class:newarticle')
    );
    ...
    $menu->addChild(
        new JMenuNode(
            JText::_('_JSHOP_PANEL_ATTRIBUTES'), 'index.php?option=com_jshopping&controller=attributes',
            'class:newarticle')
    );
    $menu->addChild(
        new JMenuNode(
            JText::_('_JSHOP_PANEL_ANSWERS'), 'index.php?option=com_jshopping&controller=answers',
            'class:newarticle')
    );
    $menu->addChild(
        new JMenuNode(
            JText::_('_JSHOP_PANEL_MEET_UPS'), 'index.php?option=com_jshopping&controller=meet_ups',
            'class:newarticle')
    );
    $menu->addChild(
        new JMenuNode(
            JText::_('_JSHOP_PANEL_QUESTIONS'), 'index.php?option=com_jshopping&controller=questions',
            'class:newarticle')
    );
    ...
    $menu->addChild(
        new JMenuNode(
            JText::_("_JSHOP_PANEL_META_DATA"), 'index.php?option=com_jshopping&controller=meta_data',
            'class:newarticle')
    );
...
//    $menu->getParent();
//    index.php?option=co   m_jshopping
