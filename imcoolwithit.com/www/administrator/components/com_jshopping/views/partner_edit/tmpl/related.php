        ...
        <?php
            ...
            <div class="block_related" id="related_product_<?php print $row_related->product_id;?>">
                <div class="block_related_inner">
                    ...
                    <div class="image"><a href="index.php?option=com_jshopping&controller=products&task=edit&product_id=<?php print $row_related->product_id;?>"><img src="<?php print getPatchProductImage($row_related->image, '', 3)?>" width="90" border="0" /></a></div>
