...
class com_jshoppingInstallerScript{
    ...
    function install($parent){
        ...
        @chmod(JPATH_SITE.'/images/places', 0755);
        ...
        <a href="index.php?option=com_jshopping">
            <img src="components/com_jshopping/images/jshop_categories_b.png" align="left" style="margin-right:10px;" /><div style="line-height:48px;">I'm cool with it</div>
        </a>
        </td>
        <td width="250">
