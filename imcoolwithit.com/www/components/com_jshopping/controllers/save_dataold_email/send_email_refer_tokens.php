...
$senderName = 'Cool';
$senderSubject = 'Refer Tokens';
$senderEmail = isset( $conf->mailfrom )? preg_replace( "/[^\.\-\_\@a-zA-Z0-9]/", "", $conf->mailfrom ) : "";


if ($senderName) {
    $message = 'We are pleased to inform that you or your friend have received a request to friends. In this regard, we add you ' . $count_tokens .  ' tokens. Invite more friends for more tokens.' . $email;
    $mail = new sendMail();
