...
class JshoppingControllerProducts extends JControllerLegacy{
    ...
    function save(){
        ...
        if ($this->getTask()=='apply'){
            $this->setRedirect("index.php?option=com_jshopping&controller=products&task=edit&product_id=".$product->product_id."&category_id=".$post['category_id'][0], 'Saved');
        }else{
            $this->setRedirect("index.php?option=com_jshopping&controller=products&category_id=".$post['category_id'][0], 'Saved');
        }
    }   
