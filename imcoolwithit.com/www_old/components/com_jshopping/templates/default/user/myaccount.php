...
<div class="profile col-sm-10 col-sm-offset-1 col-xs-12">
    ...
    <div class="page-content row">
        ...
        <div class="profile-content-left col-sm-5 col-xs-12">
            ...
            <span class="last-online"><?php print JText::_('LAST_ONLINE'); ?><?php print JText::_('DATE_FORMAT_ONLINE'); ?></span>
...
<script type="text/javascript">
    ...
    jQuery('.my-stats #edit-stats').click(function(){
        ...
        var height_value = jQuery('.profile-content-left .height');
        height_value.html('<input type="text" name="height" maxlength="5" required="required" value="' + ( (height_value.html() === '<?php print JText::_('UNKNOWN'); ?>')? '' : height_value.html() ) + '" />');
