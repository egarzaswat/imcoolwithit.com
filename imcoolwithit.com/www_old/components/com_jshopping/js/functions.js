...
function validateEditAccountForm(livepath, formName){
    ...
    if (register_field_require.looking_for){
        arrayId[i] = 'looking_for';
        arrayType[i] = 'notn';
        arrayParams[i] = '';
        arrayErrorMessages[i] = '';
        i++;
    ...
    if (register_field_require.age_look_from){
        arrayId[i] = 'age_look_from';
        arrayType[i] = 'notn';
        arrayParams[i] = '';
        arrayErrorMessages[i] = '';
        i++;
    ...
    if (register_field_require.age_look_to){
        arrayId[i] = 'age_look_to';
        arrayType[i] = 'notn';
        arrayParams[i] = '';
        arrayErrorMessages[i] = '';
        i++;
    ...
    if (register_field_require.distance){
        arrayId[i] = 'distance';
        arrayType[i] = 'nem';
        arrayParams[i] = '';
        arrayErrorMessages[i] = '';
...
function removeBookmark(userId){
    ...
    jQuery.ajax({
        type: "POST",
        url: 'index.php?option=com_jshopping&controller=user&task=removeBookmark&user_id='+userId,
        data: dataUser,
        success: function(html){
            jQuery('#userBookmarks').html(html);
        },
