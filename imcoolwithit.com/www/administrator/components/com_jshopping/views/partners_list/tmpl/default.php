...
<?php foreach($rows as $row){ ?>
  <tr class="row<?php echo $i % 2;?>">
   ...
   <td>
     <b><a href="index.php?option=com_jshopping&controller=partners&task=edit&product_id=<?php echo $row->product_id?>&category_id=<?php echo $category_id?>"><?php echo $row->name;?></a></b>
